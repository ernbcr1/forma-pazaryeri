    ...
    <section className="mb-6 overflow-hidden rounded-[2.25rem] border border-white/10 bg-[#050b18] shadow-[0_30px_90px_rgba(0,0,0,0.35)]">
      <div className="grid gap-0 lg:grid-cols-[0.95fr_1.05fr]">
        {imageUrl && !imageFailed ? (
          <div className="relative min-h-[230px] overflow-hidden border-b border-white/10 bg-[#020713] lg:border-b-0 lg:border-r">
            <img
              src={imageUrl}
            ...
            <div className="absolute inset-0 z-10 bg-gradient-to-t from-[#020713]/45 via-transparent to-transparent" />
          </div>
        ) : (
          <div className="relative min-h-[230px] overflow-hidden border-b border-white/10 bg-[radial-gradient(circle_at_30%_20%,rgba(201,166,107,0.24),transparent_28%),radial-gradient(circle_at_80%_70%,rgba(0,51,102,0.55),transparent_34%),linear-gradient(135deg,#050b18,#020713)] lg:border-b-0 lg:border-r">
            <div className="absolute inset-0 flex items-center justify-center p-6">
              <div className="rounded-3xl border border-[#c9a66b]/30 bg-black/25 px-6 py-4 text-center backdrop-blur">
                <p className="text-xs font-black uppercase tracking-[0.28em] text-[#ead8b5]">
                  elFormazione
                </p>

                <p className="mt-2 text-sm text-white/70">
                  Görsel bulunamadı veya yüklenemedi.
                </p>
              </div>
            </div>
          </div>
